...
public record ModificationDto(int Id, int RegistrationId, string RegistrationNumber, string Name, double ImpulseWeight, short MinPulseCount, short MeasurementDurationInSeconds, double Qmax);
